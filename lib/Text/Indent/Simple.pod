...
possible. It provides some methods to handle with indentation. Also it 
...
proper level and a new line as it is configured.
    ...
    $i->over;
    print $i->item("to be or not to be");
...
Copyright (c) 2017, 2018, 2019 Ildar Shaimordanov. All rights reserved. 
